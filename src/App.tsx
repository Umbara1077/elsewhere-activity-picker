import StyleStudio, { visualStyles, type VisualStyle } from './components/StyleStudio';
...
export default function App() {
 const [storedStyle,setVisualStyle]=useStored<VisualStyle>('elsewhere-visual-style','midnight');
 const visualStyle=visualStyles.some(s=>s.id===storedStyle)?storedStyle:'midnight';
 useEffect(()=>{document.documentElement.dataset.visualStyle=visualStyle;},[visualStyle]);
 ...
 return <div className="app-shell">
  ...
  <main>
   ...
   <StyleStudio value={visualStyle} onChange={setVisualStyle}/>
